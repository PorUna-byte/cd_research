...
class FLAW_CD_Dataset(CDDataset):
    """FLAW-CD dataset"""
    ...
    def results2img(self, results, imgfile_prefix, indices=None):
        ...
        Args:
            results (list[ndarray]): Testing results of the
                dataset.
            imgfile_prefix (str): The filename prefix of the jpg files.
                If the prefix is "somepath/xxx",
                the jpg files will be named "somepath/xxx.jpg".
        ...
        for result, idx in zip(results, indices):
            ...
            png_filename = osp.join(imgfile_prefix, f'{basename}.jpg')
