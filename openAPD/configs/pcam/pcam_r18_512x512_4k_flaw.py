_base_ = [
    '../_base_/models/resunetAPD_r18.py', '../_base_/datasets/flaw_cd.py',
...
evaluation = dict(interval=200, metric=['mFscore', 'mIoU'], pre_eval=True, save_best='Fscore.changed', greater_keys=['Fscore'])